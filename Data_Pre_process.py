...
if __name__ == '__main__':
    data_file_path = 'Data/KDDTrain+_20Percent_top200Item.csv'
    preprocessed_data_path = 'KDDTrain+_20Percent_processed.csv'
    global staut_list
    staut_list=[]
    preProcess(data_file_path, preprocessed_data_path)
    # print staut_list